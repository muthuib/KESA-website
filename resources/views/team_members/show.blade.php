...
<div class="container my-5" style="margin-top: 90px; position: relative;">
    ...
    <a href="{{ route('team-members.index') }}" class="btn btn-dark" style="position: absolute; top: 20px; right: 20px; z-index: 10; padding: 10px;">
        <i class="fas fa-backward"></i> Back
    </a>

    <h2 class="text-center mb-4">Team Member Details</h2>
    <div class="card shadow-sm">
        @if($teamMember->image)
            <img src="{{ asset($teamMember->image) }}" class="card-img-top" alt="{{ $teamMember->name }}" style="height: 300px;width: 300px; object-fit: cover;">
        @endif
        <div class="card-body">
