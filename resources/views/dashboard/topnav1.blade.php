        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <!-- <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle"> -->
             <i class="bi bi-person-circle fs-2 me-2" style="color: white;"></i>
            <span class="d-none d-md-block dropdown-toggle ps-2" style="color: white;">{{ Auth::user()->FIRST_NAME }} {{ Auth::user()->LAST_NAME }} ({{ Auth::user()->MEMBERSHIP_NUMBER }})</span>
            ...
            <li class="dropdown-header">
                ...
                <span>
                    @if(Auth::user()->role ?? false)
                        {{ Auth::user()->role->name }}({{ Auth::user()->MEMBERSHIP_NUMBER }})
                    @else
                       No role
                    @endif
                </span>
