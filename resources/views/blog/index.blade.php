                        ...
                        <td>
                            <div class="card p-2">
                                <div class="d-flex justify-content-center align-items-center gap-2 flex-nowrap">
                                    <a href="{{ route('blog.show', $item->id) }}" class="btn btn-info btn-sm d-flex align-items-center">
                                        <i class="fas fa-eye me-2"></i> View
                                    </a>
                                    <a href="{{ route('blog.edit', $item->id) }}" class="btn btn-warning btn-sm d-flex align-items-center">
                                        <i class="fas fa-edit me-2"></i> Edit
                                    </a>
                                    <form action="{{ route('blog.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Delete this blog post?')" class="d-inline">
                                        @csrf
                                        @method('DELETE')
