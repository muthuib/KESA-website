...
<div class="container mt-5 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0">
            <i class="fas fa-plus-circle" style="color: #800000;"></i> Add News
        </h3>
    ...
    <form id="newsForm" action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-section">
            ...
            <div class="mb-3">
                <label for="image" class="form-label">Upload Main Image or Video</label>
        ...
        <div class="action-buttons">
            <button type="submit" class="btn btn-submit">
                <i class="fas fa-save"></i> Submit News
            </button>
